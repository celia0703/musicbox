...
var background =  document.getElementsByClassName("music-player__blur")[0]
var title = document.getElementsByClassName("music__info--title")[0]
var singer = document.getElementsByClassName("music__info--singer")[0]
var url2 = document.getElementsByClassName("music-player__audio")[0]
var coverImg = document.getElementsByClassName("music-player__image")[0]
var imgs = coverImg.getElementsByTagName("img")[0]

window.onload = () => {
    window.addEventListener("storage", function (e) {
        var musicname = localStorage.getItem("musicname");
        var singer1 = localStorage.getItem("singer");
        var musicimg = localStorage.getItem("musicimg");
        var url = localStorage.getItem("url");
        imgs.src = musicimg
        title.innerText = musicname
        singer.innerText = singer1
        background.style.backgroundImage = "url(" + musicimg + ")"
        url2.src = url
...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            singer: singer.innerText,
            songUrl: url2.src,
            imageUrl:background.style.backgroundImage
        },
        ]
    }
    //根据索引获取歌曲的方法
